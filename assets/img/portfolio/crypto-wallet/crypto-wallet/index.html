...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Snazzy Crypto Wallet</title>
    <meta name="description" content="Send, receive & exchange 100+ cryptocurrencies with ease.">
...
<body>
  ...
  <header class="theme-dark hero-bg text-center-desktop text-center-mobile desktop-min-height-60vh">
      ...
      <div class="container-media">
          <img src="assets/img/crypto-wallet-hero-image.jpg" alt="cryptoWallet">
      </div>
    ...
    <main>
      ...
      <section class="section-selector-1 w-800px text-center-desktop text-center-mobile theme-dark">
        <div class="badge">Our Mission</div>
  
          
  
          <h2>Crypto with Confidence</h2>
          <p class="deckhead">Snazzy provides investors, from beginners to experts, with a comprehensive crypto trading experience, on a powerful yet user-friendly platform.</p>
...
<!-- section ends here -->
  ...
  <section class="cols-2-half theme-dark flex-row-reverse section-selector-3">
...
<!-- section ends here -->
  ...
  <section class="cols-2-half theme-dark section-selector-2">
    ...
    <div class="col-2 col-visual">
    <figure>
      <div class="container-video-yt"><iframe src="https://www.youtube.com/embed/K8qYdD1sC7w" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" width="560" height="315" frameborder="0"></iframe></div>
    </figure>
...
<!-- section ends here -->
	...
	<!-- section starts here -->
	<section class="section-selector-4 theme-dark w-1140px">
